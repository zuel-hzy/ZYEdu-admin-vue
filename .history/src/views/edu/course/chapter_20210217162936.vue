                    ...
                    <li 
                        ...
                        <P>
                            ...
                            <span class="acts">
                                ...
                                <el-button style="" type="text" @click="openEditor(chapter.id)">编辑</el-button>
                                <el-button type="text" @click="removeVideo(chapter.id)">删除</el-button>
                            </span>
                        </P>
...
export default {
    ...
    methods: {
        ...
        update(){
            chapter.updateCourseInfo(this.chapter)
                .then(response=>{
                    this.$message({
                        type: 'success',
                        message: "修改课程信息成功"
